...
static int ilitek_get_tp_module(void)
{
	...
	} else  if (NULL != strstr(panel_name, "mdss_dsi_ls_panda_slppol_ljfpc_ili9882h_swid23_720p_video")){
		fw_num = MODEL_LS_PANDA_SLPPOL_LJFPC;
	}
...
static void ili_update_tp_module_info(void)
{
	...
	case MODEL_LS_PANDA_SLPPOL_LJFPC:
		ilits->md_name = "LS_PANDA_SLPPOL_LJFPC";
		ilits->md_fw_filp_path = LS_PANDA_SLPPOL_LJFPC_FW_FILP_PATH;
		ilits->md_fw_rq_path = LS_PANDA_SLPPOL_LJFPC_FW_REQUEST_PATH;
		ilits->md_ini_path = LS_PANDA_SLPPOL_LJFPC_INI_NAME_PATH;
		ilits->md_ini_rq_path = LS_PANDA_SLPPOL_LJFPC_INI_REQUEST_PATH;
		ilits->md_fw_ili = CTPM_FW_LS_PANDA_SLPPOL_LJFPC;
		ilits->md_fw_ili_size = sizeof(CTPM_FW_LS_PANDA_SLPPOL_LJFPC);
		break;
